...
export default function SmartQueueDisplay() {
    ...
    return (
      ...
      >
        ...
        {data.isRefill ? (
          <div
            style={{
              ...
              fontWeight: 'bold',
              boxShadow: '0 4px 10px rgba(153, 27, 27, 0.4)',
              zIndex: 5,
            }}
          >
            💊 คิวรีฟิลยา
        ...
        >
          <div
            style={{
              fontSize: 'clamp(100px, 14vw, 190px)', // ขยายเพดานฟอนต์ให้ใหญ่ขึ้นอีกนิดรับกับจอที่กว้างขึ้น
              fontWeight: '900',
  ...
  return (
    ...
    >
      {/* ลดช่องว่าง padding ของ main ให้การ์ดใหญ่ชิดขอบมากขึ้น */}
      <main
        style={{
          flex: 1,
          padding: '15px',
      ...
      >
        {displayQueues.map((q, index) => (
          <QueueCard key={q ? q.id : `empty-${index}`} data={q} />
        ))}
      </main>

      {/* บีบความสูงของ Header ลง 50% (ลด padding และขนาดฟอนต์) */}
      <header
        style={{
          backgroundColor: '#111827',
          padding: '8px 20px', // ลด padding จาก 15px 40px เหลือแค่นี้
          display: 'flex',
      ...
      >
        <h1 style={{ margin: 0, color: '#F9FAFB', fontSize: '18px' }}>
          ระบบเรียกคิว
        </h1>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          <button
            ...
            style={{
              padding: '6px 15px', // บีบปุ่มให้บางลง
              fontSize: '14px', // ลดขนาดฟอนต์ปุ่ม
              fontWeight: 'bold',
              borderRadius: '6px',
              cursor: 'pointer',
              border: '2px solid',
              ...
              color: '#ffffff',
              borderColor: isRefillMode ? '#7F1D1D' : '#4B5563',
              transition: 'all 0.2s',
              display: 'flex',
              flexDirection: 'column',
              alignItems: 'center',
          ...
          <label
            style={{ fontSize: '14px', color: '#D1D5DB', fontWeight: 'bold' }}
          >
            พิมพ์เลข 4 หลัก:
          </label>
          <input
            ...
            maxLength={4}
            style={{
              padding: '6px 15px', // บีบช่องพิมพ์ให้บางลง
              fontSize: '20px', // ลดขนาดฟอนต์ในช่องพิมพ์
              borderRadius: '6px',
              border: '2px solid',
              borderColor: isRefillMode ? '#991B1B' : '#4B5563',
